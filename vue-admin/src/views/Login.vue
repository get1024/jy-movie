    ...
    <div class="login">
        <div class="login-form">
            ...
            <div style="color: #91949c;font-weight: bolder">
                ...
                <el-alert v-if="roleError" title="请您选择登入的身份" type="error" show-icon>
                </el-alert>
            ...
            <div class="login-form-footer">
                <div style="font-weight: bolder;font-size: 16px;color: #91949c;" :underline="false">
                    Copyright 2024 JY影院 - 后台管理
                </div>
            </div>
        </div>
    </div>
